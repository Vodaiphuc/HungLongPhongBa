							...
							<table class="responsive-table highlight">
								<thead>
									<tr>
										<th>#</th>
										<th><a
											href="/admin/category-blog?field=name&keywords=${keywords }&size=${size }">Tên blog</a></th>
										<th><a
											href="/admin/category-blog?field=createdBy.fullName&keywords=${keywords }&size=${size }">Người tạo</a></th>
										<th><a
											href="/admin/category-blog?field=createdDate&keywords=${keywords }&size=${size }">Ngày tạo</a></th>
										<th><a
											href="/admin/category-blog?field=lastModifiedBy.fullName&keywords=${keywords }&size=${size }">Người sửa</a></th>
										<th><a
											href="/admin/category-blog?field=lastModifiedDate&keywords=${keywords }&size=${size }">Ngày sửa</a></th>
										<th>Hoạt động</th>
									</tr>
								</thead>
								<tbody>
											...
											<aside id="right-sidebar-nav">
												<ul id="${item.id}"
													...
													<li class="center-align pt-2 pb-2 sidenav-close chat-head">
														<a href="#!"><i class="material-icons mr-0">chevron_left</i>Cập nhật blog</a>
													</li>
													<li class="chat-body">
														<div class="card-content">
																...
																<div class="row">
																	<div class="input-field col s12">
																		<button
																			...
																			type="submit">
																			Cập nhật <i class="material-icons right">send</i>
																		</button>
																	</div>
																</div>
															</form:form>
	...
	<aside id="right-sidebar-nav">
		<ul id="slide-out-new" class="sidenav slide-out-right-sidenav-chat">
			<li class="center-align pt-2 pb-2 sidenav-close chat-head"><a
				href="#!"><i class="material-icons mr-0">chevron_left</i>Tên blog mới</a></li>
			<li class="chat-body">
				<div class="card-content">
					<form:form action="/admin/category-blog/saveOrUpdate"
						modelAttribute="categoryBlog" method="post">
	...
	<div id="modalViews" class="modal">
		<div class="modal-content">
			...
			<div class="row">
				...
				<div class="col m6 s12">
					<h6 class="invoice-from">Tên blog</h6>
					<div class="invoice-address">
